...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-[color-mix(in_oklch,var(--bg)_70%,transparent)]',
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'p-6 shadow-[var(--shadow-2)] focus:outline-none',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        className,
      )}
      {...props}
    >
      ...
      <DialogPrimitive.Close
        ...
        className={cn(
          ...
          'rounded-[var(--r-1)] text-[var(--fg-muted)] hover:bg-[var(--surface-2)]',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-narrative text-[var(--fs-xl)] text-[var(--fg)]', className)}
    {...props}
  />
));
